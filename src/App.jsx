                    ...
                    <div className="space-y-3 max-h-96 overflow-y-auto">
                        {
                            leakyComponents.map(id => (
                                <LeakyComponent key={id} id={id} onEventCount={handleEventCount}/>
                            ))
                        }
                        {
                            leakyComponents.length === 0 && (
                                <div
                                    className="p-4 bg-gray-100 border border-gray-300 rounded-lg text-center text-gray-500">
                                    메모리 누수 컴포넌트를 추가해보세요
                                </div>
                            )
                        }
